...
class CinemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema" do
    assert_difference("Cinema.count") do
      post cinemas_url, params: { cinema: { location: @cinema.location, name: @cinema.name, size: @cinema.size } }
    end
  ...
  test "should update cinema" do
    patch cinema_url(@cinema), params: { cinema: { location: @cinema.location, name: @cinema.name, size: @cinema.size } }
