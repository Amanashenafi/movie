...
class CustomerOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create customer_order" do
    assert_difference("CustomerOrder.count") do
      post customer_orders_url, params: { customer_order: { cinema_placement: @customer_order.cinema_placement, customer_id: @customer_order.customer_id } }
    end
  ...
  test "should update customer_order" do
    patch customer_order_url(@customer_order), params: { customer_order: { cinema_placement: @customer_order.cinema_placement, customer_id: @customer_order.customer_id } }
